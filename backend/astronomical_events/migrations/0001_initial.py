    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.CharField(help_text='External API identifier', max_length=255, unique=True)),
                ...
                ('api_source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='astronomical_events.apisource')),
            ],
            options={
