...
const Badges = ({ children, variant = 'primary', className = '', showDot=true}) => {
  const variants = {
    ...
    blue: 'bg-[#1E3A8A] text-[#BFDBFE]  font-bold px-2 py-1 rounded-full shadow-lg z-20 justify-center',
    ...
    brown: ' bg-[#3E2723] text-[#D7BFAE]  font-bold px-3 py-1 rounded-full shadow-lg z-20 justify-center',
